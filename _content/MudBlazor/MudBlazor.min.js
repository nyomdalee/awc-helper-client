...
resetSizes(){this.firstPanel.style.width="100%";this.secondPanel.style.width="100%";this.firstPanel.style.height="100%";this.secondPanel.style.height="100%";if(this.firstPanelInitialSize!==null){this._setPanelSizes(this.firstPanelInitialSize,this._getContainerSize());}else{this.divider.ariaValueNow="50";}}
...
window.mudSplitPanel_update=function(id,horizontal,resetOnDoubleClick,minPanelSize,panelGap){window.splitPanels[id].update(horizontal,resetOnDoubleClick,minPanelSize,panelGap);};window.mudSplitPanel_resetSizes=function(id){window.splitPanels[id].resetSizes();};window.mudSplitPanel_destroy=function(id){window.splitPanels[id].destroy();};class MudResizeObserverFactory{constructor(){this._maps={};}
